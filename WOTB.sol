...
contract wBAI is ERC20, Ownable, AccessControl {
    ...
    uint256 public BALANCE_FEE = 123000321; // 0.123 wOTB
    ...
    function bridgeBack(uint256 _amount, string memory _to) public returns(bool) {
        ...
        // require greater than 0.123000321 wOTB for gas purposes.
        require(_amount > BALANCE_FEE, "Does not meet minimum amount for gas (0.123000321 wOTB)");
